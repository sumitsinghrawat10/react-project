...
const CancelAuditAlertDialog: React.FC<AlertState> = (props: AlertState) => {
  return (
    <Dialog
      open={props.cancelAuditAlert}
      className="dashboard-license-container d-flex justify-content-center flex-column DialogWrapper"
    >
      <div className="DialogWrapper">
        <DialogContent className="dialogContent">
          <span className="spanBox">
            <b>Are you sure you want to cancel the audit ? </b>
          </span>
        </DialogContent>
